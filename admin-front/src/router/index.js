...
const router = createRouter({
  ...
  routes: [
    ...
    ...merchantRoutes,
    {
      ...
      meta: { title: '监控运维', roles: ADMIN_ROLES },
    },
    {
      path: '/models',
      name: 'a7',
      component: () => import('@/views/ModelHubView.vue'),
      meta: { title: '版本管理', roles: ADMIN_ROLES },
    },
    {
      path: '/moderation',
      name: 'a8',
      component: () => import('@/views/ModerationView.vue'),
      meta: { title: '内容审核', roles: ADMIN_ROLES },
    },
    {
      path: '/ads',
      name: 'a9',
      component: () => import('@/views/AdSchedulerView.vue'),
      meta: { title: '广告运营', roles: ADMIN_ROLES },
    },
    {
      path: '/security',
      name: 'a10',
      component: () => import('@/views/SecurityView.vue'),
      meta: { title: '系统管理', roles: ADMIN_ROLES },
    },
    {
      path: '/finance',
      name: 'a11',
      component: () => import('@/views/FinanceOrderView.vue'),
      meta: { title: '财务订单', roles: ADMIN_ROLES },
    },
    {
      path: '/:pathMatch(.*)*',
      redirect: '/cluster',
